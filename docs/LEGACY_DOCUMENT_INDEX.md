...
| Stripe unbestimmt spaeter oder nur V2; alter Gate-6-Plan; damalige TEST/LIVE-UNBOUND-Staende | Vier TEST-Price-Bindungen VERIFIED, LIVE UNBOUND, Seller PLANNED und Tax PENDING_CONFIGURATION; negativer Checkout-/Webhook-Vertrag auf Staging gelockt. Positiver Checkout und echte Provideraktivierung offen, Live Billing BLOCKED. Keine Provideraktivierung aus einem Roadmap-Eintrag ableiten. | `21`, `22`, Guardrails und Release-Snapshot vom 2026-09-01 |
