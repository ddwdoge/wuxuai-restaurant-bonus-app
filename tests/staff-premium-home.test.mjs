...
test("Mitarbeiter-Navigation bietet fünf klare V1-Schnellzugriffe", () => {
...
test("Premium-Styles schützen Mobile-Layout, Safe Area und Touchflächen", () => {
  ...
  assert.match(styles, /\.staff-premium-bottom-nav[\s\S]*grid-template-columns: repeat\(5, minmax\(0, 1fr\)\)/);
