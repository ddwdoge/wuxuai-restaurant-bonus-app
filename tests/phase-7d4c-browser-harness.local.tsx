...
import "../src/modules/staff/staff-premium.css";

function Navigation() {
  const navigate = useNavigate();
  (window as any).__d4cNavigate = (slug: string) => navigate(`/staff/${slug}`);
  return null;
}
...
function StaffPage() {
  ...
  return <main className="staff-premium-shell" style={{ maxWidth: 1100, margin: "auto", padding: 12 }}>
    ...
    <div data-testid="primary-actions">Hauptaktionen bleiben sichtbar</div>
  </main>;
}
