...
const mock = fileURLToPath(new URL("./phase-7d4c-browser-mocks.local.tsx", import.meta.url));
export default defineConfig({ optimizeDeps: { entries: ["tests/phase-7d4c-browser-harness.local.html"] }, plugins: [
  { name: "compact-redemption-queue-local-mocks", enforce: "pre", resolveId(source, importer) {
