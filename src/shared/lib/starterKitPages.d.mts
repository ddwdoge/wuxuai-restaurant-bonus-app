...
export const STARTER_KIT_LAYOUT: {
  ...
  readonly restaurantName: { readonly fontSize: number; readonly lineHeight: number; readonly maxLines: number; readonly minFontSize: number; readonly y: number };
  readonly audience: { readonly fontSize: number; readonly y: number };
  readonly headline: { readonly fontSize: number; readonly lineHeight: number; readonly maxLines: number; readonly minFontSize: number; readonly y: number };
  readonly description: { readonly fontSize: number; readonly lineHeight: number; readonly maxLines: number; readonly minFontSize: number; readonly y: number };
