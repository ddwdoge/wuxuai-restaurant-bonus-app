      ...
      <div className="branding-logo-editor">
        ...
        <section aria-labelledby="logo-context-preview-title" className="branding-logo-contexts">
          ...
          <div className="branding-logo-context-grid">
            ...
            <article><div className="branding-context-header branding-context-owner"><RestaurantLogoStage {...previewProps} className="restaurant-logo-frame" size="header" /><div><small>WUXUAI Bonus</small><strong>{name}</strong><em>Inhaberbereich</em></div></div><span>Restaurant-Dashboard</span></article>
