...
export function PlatformProControlCenter() {
  ...
  const lockedPilotPreview = drawer?.kind === "access"
    && drawer.accessKind === "REAL_BUSINESS_PILOT"
    && drawer.business.country_release_state !== "RELEASED";
